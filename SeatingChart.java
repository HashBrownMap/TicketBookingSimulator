/**
 * Class that describes the plan of the airplane. 
 * We use a SeatingChart object instead of directly using a JFrame because
 * functions are easier to manipulate and are clearer. Contains a SeatingMap object so we
 * can update the GUI JTable automatically. 
 * @author Tony
 *
 */
